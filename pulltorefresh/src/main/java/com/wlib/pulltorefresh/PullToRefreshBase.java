...
import com.wlib.pulltorefresh.internal.FlipLoadingLayout;
import com.wlib.pulltorefresh.internal.LoadingLayout;
import com.wlib.pulltorefresh.internal.RotateLoadingLayout;
import com.wlib.pulltorefresh.internal.Utils;
import com.wlib.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP: {
                if (mIsBeingDragged) {
                    ...
                    if (mState == State.RELEASE_TO_REFRESH && (null != mOnRefreshListener || null !=
                            mOnRefreshListener2)) {
    ...
    protected final void setHeaderScroll(int value) {
        ...
        if (USE_HW_LAYERS) {
             ...
             */
            ViewCompat.setLayerType(mRefreshableViewWrapper, value != 0 ? View.LAYER_TYPE_HARDWARE : View
                    .LAYER_TYPE_NONE);
        }
    ...
    private void addRefreshableView(Context context, T refreshableView) {
        ...
        mRefreshableViewWrapper.addView(refreshableView, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams
                .MATCH_PARENT);

        addViewInternal(mRefreshableViewWrapper, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams
                .MATCH_PARENT));
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrAnimationStyle)) {
            mLoadingAnimationStyle = AnimationStyle.mapIntToValue(a.getInteger(R.styleable
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrScrollingWhileRefreshingEnabled)) {
            mScrollingWhileRefreshingEnabled = a.getBoolean(R.styleable
    ...
    public static interface OnPullEventListener<V extends View> {
         ...
         *                    direction the user is pulling. Only useful when <var>state</var> is {@link
