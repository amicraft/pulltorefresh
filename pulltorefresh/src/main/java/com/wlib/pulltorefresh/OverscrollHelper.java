...
import com.wlib.pulltorefresh.PullToRefreshBase.Mode;
import com.wlib.pulltorefresh.PullToRefreshBase.State;
...
public final class OverscrollHelper {
     ...
     * @param scrollX      - Current X scroll value in pixels before applying deltaY, passed through from from
     *                     overScrollBy call
     * @param deltaY       - Change in Y in pixels, passed through from from overScrollBy call
     * @param scrollY      - Current Y scroll value in pixels before applying deltaY, passed through from from
     *                     overScrollBy call
     * @param isTouchEvent - true if this scroll operation is the result of a touch event, passed through from from
     *                     overScrollBy call
     */
    public static void overScrollBy(final PullToRefreshBase<?> view, final int deltaX, final int scrollX, final int
            deltaY, final int scrollY, final boolean isTouchEvent) {
     ...
     */
    public static void overScrollBy(final PullToRefreshBase<?> view, final int deltaX, final int scrollX, final int
            deltaY, final int scrollY, final int scrollRange, final boolean isTouchEvent) {
     ...
     */
    public static void overScrollBy(final PullToRefreshBase<?> view, final int deltaX, final int scrollX, final int
            deltaY, final int scrollY, final int scrollRange, final int fuzzyThreshold, final float scaleFactor,
