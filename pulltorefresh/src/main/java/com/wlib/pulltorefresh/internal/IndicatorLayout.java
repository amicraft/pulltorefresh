...
import com.wlib.pulltorefresh.PullToRefreshBase;
...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
    ...
    public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
        ...
        Drawable arrowD = Utils.getDrawable(context, R.drawable.ptr_indicator_arrow);
        ...
        mResetRotateAnimation = new RotateAnimation(-180, 0, Animation.RELATIVE_TO_SELF, 0.5f, Animation
